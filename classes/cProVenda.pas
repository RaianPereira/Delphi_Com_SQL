...
begin
  if MessageDlg('Apagar o Registro: '+#13+#13+
                'Venda Número: '+IntToStr(VendaId),mtConfirmation,[mbYes, mbNo],0)=mrNo then
  begin
     Result:=false;
     abort;
  end;
...
function TVenda.InserirItens(cds:TClientDataSet; IdVenda:Integer):Boolean;var Qry:TZQuery;
begin
  try
    Result:= true;
    Qry:=TZQuery.Create(nil);
...
begin
  try
    ...
    Try
      ...
      // Ler da Query e Coloca no ClientDataSet
      Qry.First;
