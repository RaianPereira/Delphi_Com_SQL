...
type
  TfrmPrincipal = class(TForm)
    ...
    procedure ConsultaVenda1Click(Sender: TObject);
  private
...
procedure TfrmPrincipal.ConsultaVenda1Click(Sender: TObject);
begin
  if MessageDlg('Deseja Realmente Trocar De Usuário?', mtInformation, [mbYes, mbNo], 0) = mrNO then
     Abort;
  try
